...
<head>
  ...
  <title>Freecode.fun - API reference</title>
  <style>
    :root {
...
<body>
  <header class="top"><div class="wrap" style="padding:0;"><h1 id="doc-title">Freecode.fun</h1><span class="ver" id="doc-ver"></span></div></header>
