# Freecode.fun Desktop

Lean Electron menu-bar app for [freecode.fun](https://github.com/tashfeenahmed/freecode.fun):
...
npm run desktop:dist          # macOS → desktop/dist-electron/Freecode.fun-…-arm64.dmg
npm run desktop:dist:win      # Windows → desktop/dist-electron/Freecode.fun-…-x64 installer
```
...
- DB + config live in `~/Library/Application Support/Freecode.fun/` (macOS) /
  `%APPDATA%/Freecode.fun/` (Windows).
